...
def main():
    ...
    # Plot the loss curve for LeNet5
    ...
    # Plot the accuracy curve for LeNet5
    ...
    # Plot the loss curve for CustomMLP
    axs[1, 0].plot(train_loss_CustomMLP, label='Train Loss')
    axs[1, 0].plot(test_loss_CustomMLP, label='Test Loss')
    axs[1, 0].set_xlabel('Epoch')
    axs[1, 0].set_ylabel('Loss')
    axs[1, 0].set_title('CustomMLP - Loss Curve')
    axs[1, 0].legend()

    # Plot the accuracy curve for CustomMLP
    axs[1, 1].plot(train_acc_CustomMLP, label='Train Accuracy')
    axs[1, 1].plot(test_acc_CustomMLP, label='Test Accuracy')
    axs[1, 1].set_xlabel('Epoch')
    axs[1, 1].set_ylabel('Accuracy')
    axs[1, 1].set_title('CustomMLP - Accuracy Curve')
    axs[1, 1].legend()
